...
export function createSong(musicData, purl) {
  return new Song({
    ...
    url: purl ? `http://isure.stream.qqmusic.qq.com/${purl}` : `http://dl.stream.qqmusic.qq.com/C400${musicData.songmid}/${musicData.songid}.m4a?guid=263427534&fromtag=66`
